...
#define LFLAGS_RBL		0x00000010
#define LFLAGS_DELAY		0x00000020
...
#define IsRBLBanned(x)		((x)->localClient->localflags & LFLAGS_RBL)
#define SetRBLBanned(x)		((x)->localClient->localflags |= LFLAGS_RBL)
#define ClearRBLBanned(x)	((x)->localClient->localflags &= ~LFLAGS_RBL)

#define IsDelayExit(x)		((x)->localClient->localflags & LFLAGS_DELAY)
#define SetDelayExit(x)		((x)->localClient->localflags |= LFLAGS_DELAY)
#define ClearDelayExit(x)	((x)->localClient->localflags &= ~LFLAGS_DELAY)
